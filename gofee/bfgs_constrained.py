...
class BFGS_constrained(BFGS):
    def __init__(self, atoms, pos_init=None, restart=None, logfile='-', maxstep=.2,
        ...
        BFGS.__init__(self, atoms, restart=restart, logfile=logfile, maxstep=maxstep,
                                trajectory=trajectory, alpha=alpha,
                                master=master)
...
def relax(structure, calc, Fmax=0.01, steps_max=400, max_relax_dist=None, position_constraint=None, Epred_std_max=None):
    a = structure.copy()
    # Set calculator 
